...
> | 30 | OPEN, cosmetic: the port's backdrop stars render as chunky blue rectangles vs the C reference's small dim dots (world art export/scaling), and a dithered speckle shows in the dashboard's bottom corners that the C frame does not have. Both pre-date STAGE X/Y. |
